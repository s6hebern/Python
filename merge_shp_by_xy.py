...
path = 'D:/Uni/Masterarbeit/LUCAS/shapes'

data_2006 = path + '/2006_LAEA.shp'
data_2009 = path + '/2009_LAEA.shp'
data_2012 = path + '/2012_LAEA.shp'
...
newShp = path + '/LUCAS_all_LAEA.shp'
...
### reproject to WGS84 using module 'subprocess'

print 'Reprojecting...'

wgs84Shp = path + '/LUCAS_all_WGS84.shp'

if os.path.exists(wgs84Shp):
    driver.DeleteDataSource(wgs84Shp)

sp.call('ogr2ogr -f "ESRI Shapefile" -t_srs EPSG:32632 ' + wgs84Shp + ' ' + newShp)
